...
namespace System
{
    ...
    public partial class Random
    {
        ...
        internal static ulong NextSplitMix64(ref ulong x)
        {
        ...
        internal static uint NextSplitMix32(ref uint x)
        {
            var z = (x += 0x9e3779b9);
            z = (z ^ (z >> 16)) * 0x85ebca6b;
            z = (z ^ (z >> 13)) * 0xc2b2ae35;
        ...
        private static void ThrowMaxValueMustBeNonNegative() =>
            throw new ArgumentOutOfRangeException("maxValue", "Non-negative number required.");
        ...
        private sealed class ThreadSafeRandom : Random
        {
            ...
            [ThreadStatic]
            private static XoshiroImpl _random;

            public ThreadSafeRandom() : base(isThreadSafeRandom: true) { }

            private static XoshiroImpl LocalRandom => _random ?? Create();

            [MethodImpl(MethodImplOptions.NoInlining)]
            private static XoshiroImpl Create() => _random = new();
