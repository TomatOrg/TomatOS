...
namespace System
{
    public partial class String
    {
        ...
        private static unsafe int CompareOrdinalHelper(string strA, string strB)
        {
            ...
            ref char ap = ref strA._firstChar;
            ref char bp = ref strB._firstChar;
            ...
            if (Unsafe.Add(ref a, 1) != Unsafe.Add(ref b, 1)) goto DiffOffset1;
            ...
            length -= 2; a = ref Unsafe.Add(ref a, 2); b = ref Unsafe.Add(ref b, 2);

            // unroll the loop
            while (length >= 12)
            {
                if (Unsafe.As<char, long>(ref a) != Unsafe.As<char, long>(ref b)) goto DiffOffset0;
                if (Unsafe.As<char, long>(ref Unsafe.Add(ref a, 4)) != Unsafe.As<char, long>(ref Unsafe.Add(ref b, 4))) goto DiffOffset0;
                if (Unsafe.As<char, long>(ref Unsafe.Add(ref a, 8)) != Unsafe.As<char, long>(ref Unsafe.Add(ref b, 8))) goto DiffOffset0;
                length -= 2; a = ref Unsafe.Add(ref a, 12); b = ref Unsafe.Add(ref b, 12);
            }
            ...
            while (length > 0)
            {
                if (Unsafe.As<char, int>(ref a) != Unsafe.As<char, int>(ref b)) goto DiffNextInt;
                length -= 2;
                a = ref Unsafe.Add(ref a, 2);
        ...
        DiffOffset8: a = ref Unsafe.Add(ref a, 4); b = ref Unsafe.Add(ref b, 4);
        DiffOffset4: a = ref Unsafe.Add(ref a, 4); b = ref Unsafe.Add(ref b, 4);

        DiffOffset0:
            // If we reached here, we already see a difference in the unrolled loop above
            if (Unsafe.As<char, int>(ref a) == Unsafe.As<char, int>(ref b))
            {
                a = ref Unsafe.Add(ref a, 2);
                b = ref Unsafe.Add(ref b, 2);
            }
        ...
        DiffNextInt:
            ...
            DiffOffset1:
            Debug.Assert(Unsafe.Add(ref a, 1) != Unsafe.Add(ref b, 1), "This char must be different if we reach here!");
        ...
        public static int Compare(string? strA, int indexA, string? strB, int indexB, int length, StringComparison comparisonType)
        {
            ...
            if (indexA < 0 || indexB < 0)
            {
                ...
                throw new ArgumentOutOfRangeException(paramName, ArgumentOutOfRangeException.Index);
            }
        ...
        public static int CompareOrdinal(string? strA, int indexA, string? strB, int indexB, int length)
        {
            ...
            if (length < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(length), ArgumentOutOfRangeException.NegativeCount);
            }
        ...
        {
            ref char src = ref _firstChar;

            Debug.Assert(Unsafe.Add(ref src, this.Length) == '\0', "src[this.Length] == '\\0'");
            Debug.Assert(((int)src) % 4 == 0, "Managed string should start at 4 bytes boundary");

            uint hash1 = (5381 << 16) + 5381;
            uint hash2 = hash1;

            ref uint ptr = ref Unsafe.As<char, uint>(ref src);
        ...
        NotAscii:
            ...
            static int GetNonRandomizedHashCodeOrdinalIgnoreCaseSlow(string str)
            {
                ...
                Span<char> scratch = borrowedArr = ArrayPool<char>.Shared.Rent(length + 1);
                ...
                ref uint ptr = ref Unsafe.As<char, uint>(ref scratch[0]);
                while (length > 2)
                {
                    length -= 4;
