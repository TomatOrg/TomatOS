...
namespace System
{
    internal static partial class SpanHelpers // .Char
    {
        ...
        public static unsafe bool Contains(ref char searchSpace, char value, int length)
        {
            ...
            ref var ch = ref searchSpace;
            ref var endCh = ref Unsafe.Add(ref searchSpace, length);
            ...
            while (length >= 4)
            {
                ...
                if (value == ch ||
                    value == Unsafe.Add(ref ch, 1) ||
                    value == Unsafe.Add(ref ch, 2) ||
                    value == Unsafe.Add(ref ch, 3))
                {
                    return true;
                }

                ch = ref Unsafe.Add(ref ch, 4);
            }
        ...
        public static unsafe int LastIndexOf(ref char searchSpace, char value, int length)
        {
            ...
            ref char chars = ref searchSpace;

            ref char ch = ref Unsafe.Add(ref chars, length);
            ref char endCh = ref chars;
            ...
            while (length >= 4)
            {
                ...
                if (Unsafe.Add(ref ch,3) == value)
                    goto Found3;
                if (Unsafe.Add(ref ch,2) == value)
                    goto Found2;
                if (Unsafe.Add(ref ch, 1) == value)
                    goto Found1;
                if (ch == value)
                    goto Found;
            }
            ...
            return -1;
        Found:
            return (int)((Unsafe.ByteOffset(ref endCh, ref ch)) / sizeof(char));
        Found1:
            return (int)((Unsafe.ByteOffset(ref endCh, ref ch)) / sizeof(char)) + 1;
        Found2:
            return (int)((Unsafe.ByteOffset(ref endCh, ref ch)) / sizeof(char)) + 2;
        Found3:
            return (int)((Unsafe.ByteOffset(ref endCh, ref ch)) / sizeof(char)) + 3;
        }
