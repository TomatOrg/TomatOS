...
{ 
    public readonly partial struct DateTime : IEquatable<DateTime>
    {
        ...
        private static Span<byte> DaysInMonth365 => new byte[] { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
        private static Span<byte> DaysInMonth366 => new byte[] { 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
        ...
        private static void ThrowTicksOutOfRange() => throw new ArgumentOutOfRangeException();
        private static void ThrowInvalidKind() => throw new ArgumentException();
        private static void ThrowMillisecondOutOfRange() => throw new ArgumentOutOfRangeException();
        ...
        internal static long DoubleDateToTicks(double value)
        {
            ...
            if (millis < 0 || millis >= MaxMillis) throw new ArgumentException();
        ...
        public static DateTime FromFileTimeUtc(long fileTime)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(fileTime));
            }
