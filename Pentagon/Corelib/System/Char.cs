    ...
    private static void ConvertToUtf32_ThrowInvalidArgs(uint highSurrogateOffset)
    {
        ...
        if (highSurrogateOffset > CharUnicodeInfo.HIGH_SURROGATE_RANGE)
        {
            throw new ArgumentOutOfRangeException(
                ...
                message: "A valid high surrogate character is between 0xd800 and 0xdbff, inclusive.");
        }
        else
        {
            throw new ArgumentOutOfRangeException(
                paramName: "lowSurrogate",
                message: "A valid low surrogate character is between 0xdc00 and 0xdfff, inclusive.");
        }
    }
