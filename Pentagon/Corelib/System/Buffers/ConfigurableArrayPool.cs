...
namespace System.Buffers
{
    internal sealed partial class ConfigurableArrayPool<T> : ArrayPool<T>
    {
        ...
        private sealed class Bucket
        {
            ...
            {
                _lock = new SpinLock(/*Debugger.IsAttached*/ false); // only enable thread tracking if debugger is attached; it adds non-trivial overheads to Enter/Exit
            ...
            internal void Return(T[] array)
            {
                ...
                {
                    throw new ArgumentException(ArgumentException.BufferNotFromPool, nameof(array));
                }
