...
namespace System.Threading
{
    ...
    public struct SpinWait
    {
        ...
        public void SpinOnce(int sleep1Threshold)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(sleep1Threshold), sleep1Threshold, ArgumentOutOfRangeException.NeedNonNegOrNegative1);
            }
        ...
        public static bool SpinUntil(Func<bool> condition, int millisecondsTimeout)
        {
            ...
            if (condition == null)
            {
                throw new ArgumentNullException(nameof(condition), "The condition argument is null.");
            }
            uint startTime = 0;
