...
public readonly struct Color
{
    ...
    private static void CheckByte(int value, string name)
    {
        static void ThrowOutOfByteRange(int v, string n) =>
            throw new ArgumentException("Value of '{v}' is not valid for '{n}'. '{n}' should be greater than or equal to {byte.MinValue} and less than or equal to {byte.MaxValue}.");
            // throw new ArgumentException($"Value of '{v}' is not valid for '{n}'. '{n}' should be greater than or equal to {byte.MinValue} and less than or equal to {byte.MaxValue}.");
    ...
    public static Color FromKnownColor(KnownColor color) => new Color(color);
